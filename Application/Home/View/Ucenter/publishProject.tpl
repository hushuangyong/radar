                ...
                <form action="" method="post">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="ld-task-from-r">
                                <input type="radio" name="range" id="" value="{$user_info['school_id']}" <eq name="userPublished['quest_range']" value="$user_info['school_id']">checked = 'checked'</eq> /><label for="radio1">校内[{$user_info['school_name']}]</label>
